...
export default function About() {
  ...
  return (
    <section id="about" ref={sectionRef} className="pt-12 pb-24 md:pt-16 md:pb-32 bg-[#80E3FF] text-black font-['Montserrat'] relative overflow-hidden min-h-screen flex items-center border-t border-black/5">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-left" ref={textRef}>
            <div className="flex items-center gap-4 mb-8 md:mb-12">
              <h2 className="text-5xl md:text-7xl font-black tracking-tighter leading-none uppercase italic">THE SOUL</h2>
            ...
            <div className="space-y-6 md:space-y-8 text-base md:text-lg leading-relaxed text-gray-900 font-medium max-w-xl border-l-2 border-[#C91D73] pl-6 md:pl-8">
              ...
              <div className="pt-4 flex items-center gap-2">
                ...
                <span className="text-xs font-black uppercase tracking-widest text-[#C91D73]">The Soul Behind the City</span>
              </div>
            </div>
          </div>
