  ...
  return (
    <section id="testimonials" className="py-24 md:py-32 bg-black text-white flex items-center justify-center font-['Montserrat'] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <h2 className="text-4xl md:text-7xl font-black mb-12 md:mb-20 tracking-tighter leading-none text-center uppercase">THE WORD<br />ON THE STREET</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 text-left">
          <div className="border-l-4 border-white pl-6 md:pl-8 py-2 md:py-4">
            ...
            <cite className="text-base md:text-lg font-bold not-italic block uppercase">— MARKETING MANAGER, NOVOTEL NAIROBI</cite>
          </div>
          ...
          <div className="border-l-4 border-white pl-6 md:pl-8 py-2 md:py-4">
            ...
            <cite className="text-base md:text-lg font-bold not-italic block uppercase">— PRIVATE CLIENT, NAIROBI</cite>
          </div>
        </div>
      </div>
    </section>
